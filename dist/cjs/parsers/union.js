...
const extractMetaInfoForSchema = (schema) => {
    ...
    if (Object.keys(metaInfo).length > 0) {
        (0, parseDef_js_1.setSchemaMetaInfo)(schema._def, metaInfo);
    }
};
function parseUnionDef(def, refs) {
    ...
    if (options.every((x) => {
        const typeKey = (0, zodV3V4Compat_js_1.getDefTypeName)(x._def);
        return (typeKey &&
        ...
        const typeKey = (0, zodV3V4Compat_js_1.getDefTypeName)(x._def);
        const hasDescription = x.description || (0, parseDef_js_1.getSchemaMetaInfo)(x._def)?.description;
        return (typeKey &&
