                        ...
                        if (format === "email") {
                            switch (refs.emailStrategy) {
                                ...
                                case "format:idn-email":
                                    ...
                                    break;
                                case "pattern:zod":
                                    addPattern(res, exports.zodPatterns.email, formatMessage, refs);
                                    break;
                            }
                        }
                        else if (format === "uri") {
                            ...
                            addPattern(res, exports.zodPatterns.ulid, formatMessage, refs);
                        }
                        else if (format === "nanoid") {
                            // Use the library's nanoid pattern for consistency
                            addPattern(res, exports.zodPatterns.nanoid, formatMessage, refs);
                        }
                        else if (format === "cuid") {
                            // Use the library's CUID pattern for consistency
                            addPattern(res, exports.zodPatterns.cuid, formatMessage, refs);
                        }
                        else if (format === "cuid2") {
                            // Use the library's CUID2 pattern for consistency
                            addPattern(res, exports.zodPatterns.cuid2, formatMessage, refs);
                        }
                            ...
                            switch (refs.base64Strategy) {
                                ...
                                case "pattern:zod":
                                    ...
                                    addPattern(res, exports.zodPatterns.base64, formatMessage, refs);
                                    break;
                            }
                        }
